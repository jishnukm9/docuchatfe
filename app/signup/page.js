...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const host_name = process.env.NEXT_PUBLIC_HOST_NAME;
        ...
        const response = await fetch(`${host_name}/api-auth/signup/`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  : 'Sign Up' }
          ...
          <div className='flex justify-center mt-2'>
            <a onClick={() => redirectToSignIn()} className='text-xs text-indigo-600 cursor-pointer font-bold'>Sign In</a>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-3">
              <button
                ...
                className="w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-white bg-[#10b981] hover:bg-[#059669] hover:cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
